  ...
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            ...
            I am Full-Stack developer from Sri Lanka,and Undergratuated Student in University of Jaffna.</motion.p>
            ...
            className="grid grid-cols-auto gap-6 my-10">
                {serviceData.map(({icon,title,description,link},index)=>(
                    ...
                    className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer
                     hover:bg-lighHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white
                     '>

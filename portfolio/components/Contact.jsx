...
const Contact = () => {
   ...
   bg-[url("/footer-bg-color.png") bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        className='text-center mb-2 text-lg font-Ovo'>Conatact with me</motion.h4>
        <motion.h2 
          initial={{y:-20,opacity: 0}} 
          whileInView={{y:0,opacity: 1}} 
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            ...
            onSubmit={onSubmit} className='max-w-2x1 mx-auto'> 
             ...
             required className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md
             ...
             rows='6' placeholder='Enter your message' required 
               className='w-full p-4 outline-none border-[0.5px]
                ...
                type='submit' 
                   className='py-2 bg-black px-8 w-max flex items-center justify-between gap-2 bg-black/
